...
class EventType {
  ...
  static final Map<String, EventType> _events = {
    CLICK.toString(): CLICK,
    DBLCLICK.toString(): DBLCLICK,
    MOUSEDOWN.toString(): MOUSEDOWN,
    MOUSEUP.toString(): MOUSEUP,
    MOUSEENTER.toString(): MOUSEENTER,
    MOUSELEAVE.toString(): MOUSELEAVE,
    CONTEXTMENU.toString(): CONTEXTMENU
  };

  factory EventType.from(String name) {
    return _events[name];
  }
